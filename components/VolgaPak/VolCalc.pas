...
uses
  ...
  Forms, StdCtrls, Menus, ExtCtrls, Buttons, MaskEdit, VolDBConst;
...
{ TVolgaCalculatorForm }
  ...
  protected
    ...
    procedure MainCanResize(Sender: TObject; var NewWidth, NewHeight: Integer; var Resize: Boolean); virtual;
...
begin
  Value := OldValue; //âåðíóòü ñòàðîå çíà÷åíèå
