...
type
  ...
  TVpEventDragObject = class(TDragObjectEx)
  protected
    FEvent: TVpEvent;
    FSender: TObject;
    FDragTitle: string;
  ...
  TVpResourceCombo = class(TCustomComboBox)
    protected {private}
      ...
      procedure VpDataStoreChanged(var Msg: TLMessage); message Vp_DataStoreChanged;
...
procedure TVpResourceCombo.VpDataStoreChanged(var Msg: TLMessage);
begin
  Unused(Msg);
  LoadItems;
end;
...
procedure TVpLinkableControl.CMEnter(var Msg: TLMessage);
begin
  Unused(Msg);
  invalidate;
end;
...
procedure TVpLinkableControl.CMExit(var Msg: TLMessage);
begin
  Unused(Msg);
  invalidate;
end;
