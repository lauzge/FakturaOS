...
procedure TVpCustomCalendar.CMEnter(var Msg: TLMessage);
var
  R : TRect;
begin
  inherited;
...
procedure TVpCustomCalendar.CMExit(var Msg: TLMessage);
var
  R : TRect;
begin
  inherited;
...
procedure TVpCustomCalendar.CMFontChanged(var Msg: TLMessage);
begin
  inherited;
