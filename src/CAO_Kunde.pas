...
type
  ...
  TAdressForm = class(TForm)
    ...
    APTelefonBtn: TSpeedButton;
    APTelPrivBtn: TSpeedButton;
    APMobilfunkBtn: TSpeedButton;
    APemailBtn: TSpeedButton;
    APEmail2Btn: TSpeedButton;
    tele1Btn: TSpeedButton;
    tele2Btn: TSpeedButton;
    funkBtn: TSpeedButton;
    emailBtn: TSpeedButton;
    email2Btn: TSpeedButton;
    internetBtn: TSpeedButton;
